...
public class ExtJSNature implements IProjectNature {
    ...
    public static IProjectFacet getExtjsFacet() {
    	return ProjectFacetsManager.getProjectFacet(ExtJSCore.FACET_EXT);
    }
    
    public static IProjectFacet getSenchaTouchFacet() {
    	return ProjectFacetsManager.getProjectFacet(ExtJSCore.FACET_TOUCH);
    }
