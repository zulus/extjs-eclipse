...
public class ExtJSPackageImpl extends EPackageImpl implements ExtJSPackage {
	 ...
	 * @generated
	 */
	private EEnum librarySourceTypeEEnum = null;
	 ...
	 * @generated
	 */
	public EAttribute getExecutionEnvironment_Builtin() {
	 ...
	 * @generated
	 */
	public EAttribute getExecutionEnvironment_Versions() {
		return (EAttribute)executionEnvironmentEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getExecutionEnvironment_CorePath() {
		return (EAttribute)executionEnvironmentEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getExecutionEnvironment_CoreType() {
		return (EAttribute)executionEnvironmentEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getExecutionEnvironment_Libraries() {
		return (EAttribute)executionEnvironmentEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLibrary_Builtin() {
	 ...
	 * @generated
	 */
	public EAttribute getLibrary_Versions() {
	 ...
	 * @generated
	 */
	public EClass getLibrarySource() {
		return librarySourceEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getLibrarySource_Type() {
		return (EAttribute)librarySourceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLibrarySource_Path() {
		return (EAttribute)librarySourceEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLibrarySource_Inclusions() {
		return (EAttribute)librarySourceEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLibrarySource_Exclusions() {
		return (EAttribute)librarySourceEClass.getEStructuralFeatures().get(3);
	}
    ...
    public void createPackageContents() {
		...
		createEAttribute(executionEnvironmentEClass, EXECUTION_ENVIRONMENT__BUILTIN);
		createEAttribute(executionEnvironmentEClass, EXECUTION_ENVIRONMENT__VERSIONS);
    ...
    public void initializePackageContents() {
		...
		initEAttribute(getExecutionEnvironment_Builtin(), ecorePackage.getEBoolean(), "builtin", null, 0, 1, ExecutionEnvironment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExecutionEnvironment_Versions(), ecorePackage.getEString(), "versions", null, 0, -1, ExecutionEnvironment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(librarySourceTypeEEnum, LibrarySourceType.ZIP_FILE);
		addEEnumLiteral(librarySourceTypeEEnum, LibrarySourceType.FOLDER);
		addEEnumLiteral(librarySourceTypeEEnum, LibrarySourceType.JAVASCRIPT_FILE);
