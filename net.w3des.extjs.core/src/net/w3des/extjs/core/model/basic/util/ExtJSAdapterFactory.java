...
public class ExtJSAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ExtJSSwitch<Adapter> modelSwitch =
        new ExtJSSwitch<Adapter>() {
			...
			@Override
			public Adapter caseLibrarySource(LibrarySource object) {
    ...
    /**
	 * Creates a new adapter for an object of class '{@link net.w3des.extjs.core.model.basic.ExecutionEnvironment <em>Execution Environment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createExecutionEnvironmentAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link net.w3des.extjs.core.model.basic.Library <em>Library</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createLibraryAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link net.w3des.extjs.core.model.basic.LibrarySource <em>Library Source</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
