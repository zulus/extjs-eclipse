...
public class Env42Test {

    private IProject project = null;

    @Before
    public void createProject() throws CoreException {
        project = Util.createJSProject("env-project-42", true);
    }
    ...
    public void envChangedOnVersionInstall() throws CoreException {
    	...
    	final IProjectFacetVersion facet42 = ProjectFacetsManager.getProjectFacet(ExtJSCore.FACET_EXT).getVersion("4.2");
        facetedProject.installProjectFacet(facet42, null, null);
        
        IExtJSProject prj = ExtJSCore.getProjectManager().createProject(project);
        assertEquals(prj.getEnvironmentName(), ExtJSCore.getLibraryManager().getDefaultEnvName(facet42));
    }
